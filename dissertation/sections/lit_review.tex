...
Statistical downscaling refers to generating a statistical link between a low and high fidelity models.
The process of statistical downscaling and augmentation is not without precedent.  In particular, in the climate and weather data communities, it is common to perform local bias-correction on coarsely resolved weather models provided local weather station measurements [ref].  
