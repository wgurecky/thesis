...
\begin{figure}[H]
    ...
    \label{fig:gridnueff}
\end{figure}
This work is important because it repents an early approach to building experimentally informed hi2lo subchannel models.  The Yao model is still employed by modern subchannel codes such as CTF to obtain more accurate rod surface temperature distributions near the spacer grids.
