...
Statistical downscaling (SD) methods attempt to preserve statistical properties of sparsely available, historical, high fidelity data when making forecasts in time or space. The forecasting model is typically quickly executing and has low spatial and temporal resolution.  In general, the goal at runtime of the low fidelity forecasting tool is to obtain mean and higher moment estimates of a random field at any desired location, or, at a very fine resolution.
