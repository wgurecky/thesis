...
The primary porous matrix of crud is \ce{NiFe_2O_4}, however, there are other constituents such as Nickel oxide, \ce{Ni_2FeBO_5} and \ce{Li_2B_4O_7} compounds \cite{Henshaw2006TheCO} \cite{mongoose17}. In particular, the porous matrix of \ce{NiFe_2O_4} is filled in by precipitated \ce{Li_2B_4O_7} in regions which experience boiling, thus trapping boron inside the crud layer.  The net result of the trapped boron in the crud layer is a shift in power towards the bottom of the core.
\index{Crud!Boron}
