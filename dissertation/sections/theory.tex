...
Other strategies to model univariate density functions are abundant.  One alternative is to use a set of sample moments.  Next, a set of moment conditions is defined for the target parametric model.  Then the method of moments can be used to determine the parameters of the parametric model which best satisfy the moment conditions in the L2 norm sense.
