...
\matrix (m) [matrix of math nodes,row sep=0.9em,column sep=0.5em,minimum width=0.5em]
  {
      ...
      & & &\\  %m-3
    \{\mathbf X, \omega \}^{\ell_0} & \{\mathbf X, \omega \}^{\ell_0} & \{...\}^{\ell_0} & \ \ \ ...\ \ \ \  & \{\mathbf X, \omega \} & \{\mathbf X, \omega \} & ... \\ %m-4
                           &\\ %m-5
    \{\mathbf X', \bar \omega' \} & \{\mathbf X', \bar \omega' \} & \{...\}^{\ell_0}  & ... &  \{\mathbf X, \omega \} & \{\mathbf X', \bar \omega' \} & ... \\ %m-6
     . & . & . & . & . & . & . &  \\ %m-7
    \{\mathbf C, \bar \omega' \} & \{\mathbf C, \bar \omega' \} & \{...\}^{\ell_0} &  ... &  \{\mathbf X, \omega \} & \{\mathbf C, \bar \omega' \} & ... \\ %m-8
                           &\\ %m-9
    C_{m,s_0}^{\ell_0} & C_{m,s_1}^{\ell_0} & C_{m,s_2}^{\ell_0} & ... &  C_m  & C_m & C_{m,s}^{\ell_1} \\ %m-10
  };
  \path[-stealth]
  ...
  %
          (m-6-1) edge node [right] {$\mathcal G(\mathbf X'|\mathbf C_{0})$} (m-8-1)
          (m-6-2) edge node [right] {$\mathcal G(\mathbf X'|\mathbf C_{s-1})$} (m-8-2)
          (m-6-3) edge node [right] {$\mathcal G(\mathbf X'|\mathbf C_{s-1})$} (m-8-3)
  %
