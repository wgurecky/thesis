...
\begin{columns}
    \begin{column}{0.5\textwidth}
        \begin{figure}[H]%
            \centering
            \includegraphics[width=0.85\linewidth]{/dissertation/figs/synth/ctf_asm0_z_twall}       
    ...
    \begin{column}{0.5\textwidth}
         \begin{figure}[H]%
            \centering
             \includegraphics[width=0.85\linewidth]{/dissertation/figs/synth/pinH5TempOut}
...
\begin{columns}
    \begin{column}{0.5\textwidth}
        \begin{figure}[H]%
            \centering
            \includegraphics[width=0.85\linewidth]{/dissertation/figs/synth/ctf_pin_h5_temperature}
            \caption{\centering Original CTF single pin \\ temperature result.}%
        \end{figure}
    \end{column}
    \begin{column}{0.5\textwidth}
        \begin{figure}[H]%
            \centering
            \includegraphics[width=0.85\linewidth]{/dissertation/figs/synth/cfd_pin_temperature}
            \caption{\centering Augmented CTF temperature \\ result.}%
            \label{fig:ctf_twall_aug}%
        \end{figure}
    \end{column}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{/dissertation/figs/synth/patch_scatter_0_4_0_6_v2}
...
\centering
\begin{minipage}{.5\textwidth}
  \includegraphics[width=0.95\linewidth]{figs/dboron_dt_tke.png}
\caption{\centering Crud growth rate TKE \\ sensitivity vs. Time. \\ $T=620[K], q''=100[W/cm^2]$.} 
\label{fig:crud_pre_map}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \includegraphics[width=0.95\linewidth]{figs/dboron_dt_t.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{/dissertation/figs/synth/patch_crud_fit_80}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{/dissertation/figs/synth/nsample_study/cmpr_pin_totals_violin_nsample}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{/dissertation/figs/synth/tstep_study/cmpr_pin_totals_violin}
