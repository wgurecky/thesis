...
\begin{frame}
\begin{itemize}
    \item Augment baseline CTF result by a user-specified stochastic component:
\end{itemize}
\end{frame}
...
\section[ML Results]{Machine Learning Driven Hi2lo Results Provided CFD Data Source}
% =========================================================================== %
