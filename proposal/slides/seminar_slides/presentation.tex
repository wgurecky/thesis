...
\begin{frame}
    ...
    Crud forms a porous layer on the surface of fuel rods.  Crud is primarily comprised of \ce{NiFe_2O_4} (Nickel Ferrite).
\begin{small}
    \begin{itemize}
...
\vspace{-12pt}
\begin{itemize}
    \item CIPS influences the burnup distribution over a cycle.  Missed burnup targets means less bang for the buck  \citation{Lang2017}.
