...
\vspace{-12pt}
    \begin{figure}
        ...
        \begin{minipage}{.5\textwidth}
            \centering
            \includegraphics[width=0.5\textwidth]{figs/crud-crud.jpg}
        \end{minipage}%
        \begin{minipage}{.5\textwidth}
            \centering
            \includegraphics[width=0.5\textwidth]{figs/crud_flake_ex.png}
        \end{minipage}
    \end{figure}
\end{frame}
...
% =========================================================================== %
\begin{frame}
\frametitle{Relative Integrated Crud Mass Errors}
\vspace{-42pt}
\begin{columns}
    \begin{column}{0.5\textwidth}
        \begin{figure}[H]%
    ...
    \begin{table}[h]
        ...
        \begin{center}
            ...
            \begin{tabular}[h]{|c|c|c|c|}
                \hline
                Pin & Hi2lo Bmass $[g]$ & Hi2lo-CFD $[g]$ & Rel Diff \% \\
                \hline
...
% =========================================================================== %
\begin{frame}
\frametitle{5x5 Assembly Crud Results Summary}
\vspace{-8pt}
\begin{table}[h]
    \tiny
    \begin{center}
        ...
        \begin{tabular}[h]{|c|c|c|M|c|c|M|}
            \hline
            Pin & CTF Bmass $[g]$ & CFD Bmass $[g]$ & CTF-CFD Rel Diff \% & Hi2lo Bmass $[g]$ & Hi2lo-CFD $[g]$ & Hi2lo-CFD Rel Diff \% \\
            \hline
