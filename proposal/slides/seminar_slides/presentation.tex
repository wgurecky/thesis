...
\begin{itemize}
    \item Obtain $\{\}$ via evaluation gradient boosted regression: .
...
%\subsection*{Sampling}
%\begin{frame}
%\frametitle{Sampling and Time Stepping Review}
%\end{frame}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{/dissertation/figs/5x5/5x5_top_down}
...
\begin{table}[h]
    \begin{center}
        \caption{Features included in the gradient boosted models as exogenous variables.}
...
\begin{itemize}
    \item Copula behavior vs. axial position.
\end{itemize}
\end{frame}
...
\subsection*{Machine Learning Results}
\begin{frame}
\frametitle{Gradient Boosting Prediction Results: TKE conditional quantiles}
\end{frame}

% =========================================================================== %
\begin{frame}
\frametitle{Gradient Boosting Prediction Results: Temperature conditional quantiles}
\end{frame}

% =========================================================================== %
\begin{frame}
\frametitle{Gradient Boosting Prediction Results: Kendall's $\tau$}
\end{frame}

% =========================================================================== %
\subsection*{Crud Results}
\begin{frame}
\frametitle{Single Pin Crud Results}
\end{frame}

% =========================================================================== %
\begin{frame}
\frametitle{Single Pin Crud Results Cont.}
\end{frame}
