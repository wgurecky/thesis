...
A unique blended copula model can be specified in each span providing spatially differentiated, correlated tri-variate $P(temperature,\ tke,\ bhf)$  distributions.
